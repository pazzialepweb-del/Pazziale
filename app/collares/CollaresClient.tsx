// app/collares/page.tsx (o CollaresClient.tsx si prefieres mantener la estructura)
'use client';
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-serif mb-4 text-white">
              Nuestros <span className="text-[#EC4899]">Collares</span>
            </h1>
            <p className="text-gray-400 max-w-2xl mx-auto font-light">
              Descubre nuestra colección de collares artesanales, piezas que realzan tu cuello con sofisticación y estilo único.
            </p>
          </div>

          {loading ? (
            <div className="flex justify-center items-center h-64" role="status" aria-label="Cargando collares">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
              {productos.length > 0 ? (
                ...
                <div className="col-span-full text-center text-gray-400 py-12" role="status">
                  No hay collares disponibles en este momento. Vuelve pronto para ver nuevos diseños.
                </div>
              )}
            </div>
          )}
