...
export default function ArosClient() {
  ...
  const CATEGORIA = 'Pendientes'; // ✅ La categoría en la base de datos es "Pendientes"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-serif mb-4 text-white">
              Nuestros <span className="text-[#EC4899]">Aros</span>
            </h1>
          ...
          {loading ? (
            <div className="flex justify-center items-center h-64" role="status" aria-label="Cargando aros">
                    ...
                    <Link href={`/producto/${producto.id}`} className="block">
                      <div className="aspect-square overflow-hidden rounded-lg bg-[#1E1E1E] mb-4 relative">
                        <Image
                          ...
                          alt={`${producto.nombre} - Aro Pazziale`}
                          width={400}
                          height={400}
