    ...
    <div className="min-h-screen bg-[#1E1E1E] text-white">
      ...
      <section className="relative pt-32 pb-16 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="flex items-center justify-center gap-2 mb-4 animate-fade-in-up">
            <span className="inline-block w-12 h-[2px] bg-[#EC4899]"></span>
          ...
          <div>
            ...
            <div className="mt-6 flex gap-4">
              <span className="flex items-center gap-1 text-[#EC4899]">
                <Sparkles className="w-4 h-4" /> Hecho a mano
              </span>
              <span className="flex items-center gap-1 text-[#F59E0B]">
                <Heart className="w-4 h-4" /> Con amor
              </span>
            </div>
          </div>
      ...
      <section className="py-20 bg-[#1E1E1E]">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-[#2D2D2D] p-8 rounded-xl border border-[#F59E0B]/30 hover:border-[#EC4899] transition-all duration-300 group text-center">
              <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-[#EC4899]/10 border border-[#EC4899]/30 flex items-center justify-center group-hover:bg-[#EC4899] group-hover:text-[#1E1E1E] transition-all duration-300">
                <PenTool className="w-8 h-8 text-[#EC4899] group-hover:text-[#1E1E1E]" />
              </div>
              <h3 className="text-xl font-serif mb-2 text-[#EC4899]">Diseño</h3>
              <p className="text-gray-400 text-sm font-light">Cada pieza comienza con un boceto inspirado en la naturaleza, la geometría y la emoción.</p>
            </div>
            <div className="bg-[#2D2D2D] p-8 rounded-xl border border-[#F59E0B]/30 hover:border-[#EC4899] transition-all duration-300 group text-center">
              <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-[#F59E0B]/10 border border-[#F59E0B]/30 flex items-center justify-center group-hover:bg-[#F59E0B] group-hover:text-[#1E1E1E] transition-all duration-300">
                <Hammer className="w-8 h-8 text-[#F59E0B] group-hover:text-[#1E1E1E]" />
              </div>
              <h3 className="text-xl font-serif mb-2 text-[#F59E0B]">Forja</h3>
              <p className="text-gray-400 text-sm font-light">El metal cobra vida bajo el martillo, moldeado con precisión y dedicación.</p>
            </div>
            <div className="bg-[#2D2D2D] p-8 rounded-xl border border-[#F59E0B]/30 hover:border-[#EC4899] transition-all duration-300 group text-center">
              <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-[#EC4899]/10 border border-[#EC4899]/30 flex items-center justify-center group-hover:bg-[#EC4899] group-hover:text-[#1E1E1E] transition-all duration-300">
                <Diamond className="w-8 h-8 text-[#EC4899] group-hover:text-[#1E1E1E]" />
              </div>
      ...
      <section className="py-20 bg-[#2D2D2D]">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-[#1E1E1E] p-6 rounded-xl border border-[#F59E0B]/30 hover:border-[#EC4899] transition-all duration-300">
              <h3 className="text-xl font-serif mb-2 text-[#EC4899]">Materiales de calidad</h3>
              <p className="text-gray-400 text-sm font-light">Trabajamos con metales nobles y piedras de primera calidad, seleccionados cuidadosamente para garantizar la durabilidad y belleza de cada pieza.</p>
            </div>
            <div className="bg-[#1E1E1E] p-6 rounded-xl border border-[#F59E0B]/30 hover:border-[#EC4899] transition-all duration-300">
              <h3 className="text-xl font-serif mb-2 text-[#F59E0B]">Diseño exclusivo</h3>
              <p className="text-gray-400 text-sm font-light">Cada joya es única, diseñada y fabricada a mano en nuestro taller. No fabricamos en masa, cada pieza cuenta una historia.</p>
            </div>
            <div className="bg-[#1E1E1E] p-6 rounded-xl border border-[#F59E0B]/30 hover:border-[#EC4899] transition-all duration-300">
              <h3 className="text-xl font-serif mb-2 text-[#EC4899]">Atención personalizada</h3>
              <p className="text-gray-400 text-sm font-light">Te ofrecemos un trato cercano y personalizado, asesorándote en cada paso para que encuentres la pieza perfecta.</p>
            </div>
            <div className="bg-[#1E1E1E] p-6 rounded-xl border border-[#F59E0B]/30 hover:border-[#EC4899] transition-all duration-300">
              <h3 className="text-xl font-serif mb-2 text-[#F59E0B]">Sostenibilidad</h3>
              <p className="text-gray-400 text-sm font-light">Comprometidos con el medio ambiente, utilizamos prácticas responsables en la obtención de materiales y la producción.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#1E1E1E]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="mb-6">
            <span className="text-4xl text-[#EC4899] opacity-20">✦</span>
          </div>
