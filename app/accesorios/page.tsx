      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-serif mb-4 text-white">Nuestros <span className="text-[#EC4899]">Accesorios</span></h1>
            <p className="text-gray-400 max-w-2xl mx-auto font-light">
              Descubre nuestra colección de accesorios artesanales, diseñados para complementar tu estilo con elegancia y sutileza.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
              {productos.length > 0 ? (
                ...
                <div className="col-span-full text-center text-gray-400 py-12">
                  No hay accesorios disponibles en este momento. Vuelve pronto para ver nuevos diseños.
                </div>
              )}
            </div>
          )}
