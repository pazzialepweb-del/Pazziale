...
// 🔥 Se lee desde el .env.local. Cuando pases a producción, solo cambias el valor de la variable en Vercel.
...
export async function POST(request: Request) {
  try {
    ...
    // 2. (Opcional) Verificar la firma de Mercado Pago (descomentar si configuras el secreto)
    /*
    ...
    */
    ...
    if (!mpResponse.ok) {
      throw new Error('Error al consultar el pago en Mercado Pago');
    }
