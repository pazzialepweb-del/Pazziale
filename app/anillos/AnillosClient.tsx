...
export default function AnillosClient() {
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-serif mb-4 text-white">
              Nuestros <span className="text-[#EC4899]">Anillos</span>
            </h1>
            <p className="text-gray-400 max-w-2xl mx-auto font-light">
              Descubre nuestra colección de anillos artesanales, diseñados para marcar momentos especiales con elegancia y distinción.
            </p>
          </div>

          {loading ? (
            <div className="flex justify-center items-center h-64" role="status" aria-label="Cargando anillos">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
              {productos.length > 0 ? (
                    ...
                    <Link href={`/producto/${producto.id}`} className="block">
                      <div className="aspect-square overflow-hidden rounded-lg bg-[#1E1E1E] mb-4 relative flex items-center justify-center">
                        <Image
                          ...
                          alt={`${producto.nombre} - Anillo Pazziale`}
                          width={400}
                          height={400}
                ...
                <div className="col-span-full text-center text-gray-400 py-12" role="status">
                  No hay anillos disponibles en este momento. Vuelve pronto para ver nuevos diseños.
                </div>
              )}
            </div>
          )}
